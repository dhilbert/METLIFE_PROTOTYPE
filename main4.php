...
<link rel="stylesheet" href="https://design.metlife.com/etc.clientlibs/MetlifeMarketCore/components/content/global/hero-detail/clientlibs.min.css" type="text/css">
                                ...
                                <div class="col-12 col-sm-10 col-md-11">
                                    <div class="headline__border">
                                        <div class="headline__title">
                                            <h2 class="font-header-4 font-header-2-md">사회혁신조직 투자육성 Inclusion Plus
</h2>
                                        </div>
                                        <div class="headline__copy">
                                            <p class="font-body-1 font-body-3-sm font-body-1-md">
                                            함께 성장할 때 우리 금융사회는 더욱 건강 해집니다. 메트라이프생명 사회공헌재단은 Inclusion Plus를 통해 금융소외계층부터 모두의 건강한 금융 생활(Financial health)을 더 건강하게 만드는 솔루션 발굴과 사회혁신 조직의 역량 강화를 지원합니다. 본 프로그램을 통해 금융소외계층의 금융상품 및 서비스 접근을 높이고, 금융지식을 습득하도록 돕고 경제활동 참여가 낮은 이들의 경제적 자립을 지원할 수 있는 다양한 솔루션 발굴의 장입니다.
