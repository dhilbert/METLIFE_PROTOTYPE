...
while($info	 = mysqli_fetch_array($res)){
    ...
    $temp_want = array($info['ARTICL_NO'],$info['ARTICL_SJ'],$info['REGIST_DT'],$info['STRE_COURS'],$info['STRE_FILE_NM'],$info['ARTICL_TY']	);

    if(in_array($info['ARTICL_NO'],$check_nu)){


    }else{

        array_push( $want[$rand],$temp_want);
        array_push($check_nu,$info['ARTICL_NO']);
    }
            ...
            <div class="row">
                <div class="col-12 col-sm-12">
                    <div class="hero-general__content">
                        <div class="hero-general__title font-header-4 font-header-2-md">공지사항
...
<div class="search-wrap">
				...
				<span class="input-box">
					<input type="text" name="searchKeyword" value="" autocomplete="off">
				</span>
				<button type="button" class="btn btn-search" id="btnSubmit">검색</button>
				</form>
			</div>
-->
                            ...
                            <div class="col-12 col-md-10 offset-md-1 responsive-columns">
                                <div class="row article-grid-filter-wrapper">
                                    <div class="col-12 article-grid-title">
                                        ...
                                        <h2 id="column-article-grid-921752119--labelledby">공지사항</h2>
                                    </div>
