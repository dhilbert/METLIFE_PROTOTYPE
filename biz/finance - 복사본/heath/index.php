            ...
            <div class="row">
                <div class="col-12 col-sm-10">
                    <div class="hero-general__content">
                        <div class="hero-general__title font-header-4 font-header-2-md">사회혁신조직 투자육성 Inclusion Plus</div>
                        <div class="hero-general__subcopy font-body-1 font-body-3-sm font-body-1-md">
                        함께 성장할 때 우리 금융사회는 더욱 건강 해집니다. 메트라이프생명 사회공헌재단은 Inclusion Plus를 통해 금융소외계층부터 모두의 건강한 금융 생활(Financial health)을 더 건강하게 만드는 솔루션 발굴과 사회혁신 조직의 역량 강화를 지원합니다. 본 프로그램을 통해 금융소외계층의 금융상품 및 서비스 접근을 높이고, <b>금융지식을 습득하도록 돕고 경제활동 참여가 낮은 이들의 경제적 자립을 지원할 수 있는 다양한 솔루션 발굴의 장입니다.</b>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-12  col-md-11  offset-md-1 product-info-container">
            <div class="col-12 col-sm-7  product-info-container__title font-header-4 font-header-2-md">사회혁신조직 투자 및 육성 프로그램 (2019년~)
</div>
...
<div class="container">
    <div class="row">
        <div class="col-12  col-md-10 offset-md-1 product-info-border"></div>
        <div class="col-12  col-md-11  offset-md-1 product-info-container">
            <div class="col-12 col-sm-7  product-info-container__title font-header-4 font-header-2-md">사회혁신 경진대회(2018~)
</div>
            <div class="col-12 col-sm-2  product-info--indicators">
                <button class="carousel-control left js-leftClick">
                    <svg class="icon" aria-hidden="true" tabindex="-1" focusable="false">
...
<section id="visual-product-card-352261906" class="visual-product-card component component__spacing-bottom " role="region" aria-labelledby="visual-product-card-352261906--labelledby">
    ...
    <div class="visual-product-card__image-container">
            ...
            <div class="visual-product-card__image bg" style="background-image: url('https://metlifewelfare.org/images/app/inclusion-Plus-1.jpg');">
            </div>
    ...
    <div class="visual-product-card__image-container">
            ...
            <div class="visual-product-card__image bg" style="background-image: url('https://metlifewelfare.org/images/app/inclusion-Plus-4.jpg');">
            </div>
        ...
        <div class="row">
            <div class="col-11  offset-md-1  responsive-columns">
                <div class="divider__line gradient" style="height: 6px; ">
                    ...
                    <div class="divider__copy richtext richtext-wysiwyg">
                        <p><span class="font-header-2">동영상영역</span></p>
